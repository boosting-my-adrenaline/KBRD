...
export const TAPREDONEnumberOne: React.FC = () => {
  const { themeColor2 } = useColor()
  return (
    <div
      className={` w-500px h-500px flex flex-row items-center justify-center `}
    ...
    >
      ...
      >
        ...
        <path
          ...
          className={`${themeColor2.fill.t400} ${themeColor2.stroke.t600}`}
        />
      </svg>
    </div>
  )
}
export const TAPREDONEnumberTwo: React.FC = () => {
  const { themeColor2 } = useColor()
...
export const TAPREDONEnumberThree: React.FC = () => {
  const { themeColor2 } = useColor()
